...
#all_predictions = (model.predict() ) * reverse_mask                            
...
# 根据评分最高的物品查找其它相似物品
#_, rank = utils.euclidean_rank(model.I, model.I[userid])
_, rank = utils.cosine_rank(model.I, model.I[preferred_item])
